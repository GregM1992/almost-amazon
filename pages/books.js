      ...
      <div class="card">
        ...
        <div class="card-body" style="height: 180px;">
          <h5 class="card-title">${item.title}</h5>
            ...
            <hr>
            <i class="btn btn-success fas" id="view-book-btn--${item.firebaseKey}">Details</i>
            <i id="edit-book-btn--${item.firebaseKey}" class="fas btn btn-info">Edit</i>
